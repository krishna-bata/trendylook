...
// @route POST /api/cart
// @desc Add a product to cart for a guest or admin user
// @access Public
...
// @route PUT /api/cart
// @desc Update quanitity in the cart for a guest or admin user
// @access Public
  ...
  try {
    ...
    if (guestCart) {
      ...
      if (userCart) {
        ...
        // If the user has no existing cart then assign guest cart to user cart
