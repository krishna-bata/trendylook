...
// @desc Retrive the product (8) based on the creation date
// @access Public
...
// @desc Get the single product by ID
// @access Public
...
// @desc Retrive similar product based on the current product's gender and category
// @access Public
